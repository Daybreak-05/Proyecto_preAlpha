    ...
    <div class="py-10 pb-16">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <a href="<?php echo e(route('productos.index')); ?>" class="group rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_38px_-26px_rgba(15,23,42,.55)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_-22px_rgba(15,23,42,.65)]">
                ...
                <a href="<?php echo e(route('proveedores.index')); ?>" class="group rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_38px_-26px_rgba(15,23,42,.55)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_-22px_rgba(15,23,42,.65)]">
                ...
                <a href="<?php echo e(route('proveedores.create')); ?>" class="group rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_38px_-26px_rgba(15,23,42,.55)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_-22px_rgba(15,23,42,.65)]">
                ...
                <a href="<?php echo e(route('index')); ?>" class="group rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_38px_-26px_rgba(15,23,42,.55)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_-22px_rgba(15,23,42,.65)]">
                ...
                <a href="<?php echo e(route('estanterias.index')); ?>" class="group rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_38px_-26px_rgba(15,23,42,.55)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_-22px_rgba(15,23,42,.65)]">
                ...
                <a href="<?php echo e(route('estanterias.create')); ?>" class="group rounded-3xl border border-slate-200 bg-white p-6 shadow-[0_16px_38px_-26px_rgba(15,23,42,.55)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_22px_48px_-22px_rgba(15,23,42,.65)]">
...
<?php endif; ?><?php /**PATH /var/www/html/piconmp/proyecto/Proyecto_Alpha/resources/views/dashboard.blade.php ENDPATH**/ ?>