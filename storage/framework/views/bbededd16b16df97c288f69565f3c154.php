        ...
        <footer class="bg-slate-900 text-slate-300 border-t border-slate-700 mt-12">
            <div class="max-w-7xl mx-auto px-4 py-8">
			    ...
			    <ul class="space-y-2 text-sm">
			        <li>
			            <a href="<?php echo e(route('sobre')); ?>" class="hover:text-emerald-400">
			                Sobre nosotros
			            </a>
			        </li>
			        <li>
			            <a href="<?php echo e(route('contacto')); ?>" class="hover:text-emerald-400">
			                Contacto
			            </a>
			        </li>
			        <li>
			            <a href="<?php echo e(route('privacidad')); ?>" class="hover:text-emerald-400">
			                Política de privacidad
			            </a>
			        </li>
			        <li>
			            <a href="<?php echo e(route('terminos')); ?>" class="hover:text-emerald-400">
			                Términos y condiciones
			            </a>
			        </li>
			        <li>
			            <a href="<?php echo e(route('cookies')); ?>" class="hover:text-emerald-400">
			                Cookies
			            </a>
			        </li>
			    </ul>
                ...
                <div class="border-t border-slate-700 mt-8 pt-4 text-center text-sm text-slate-500">
                    © <?php echo e(date('Y')); ?> UBIKA. Todos los derechos reservados.
                </div>
...
<?php /**PATH /var/www/html/piconmp/proyecto/Proyecto_Alpha/resources/views/layouts/app.blade.php ENDPATH**/ ?>