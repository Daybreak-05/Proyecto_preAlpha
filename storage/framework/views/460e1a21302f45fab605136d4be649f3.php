...
<?php endif; ?>
        ...
        <div class="flex flex-col gap-3 pt-2">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="text-center text-sm text-slate-600 hover:text-emerald-600 transition font-medium" href="<?php echo e(route('password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /var/www/html/piconmp/proyecto/Proyecto_Alpha/resources/views/auth/login.blade.php ENDPATH**/ ?>